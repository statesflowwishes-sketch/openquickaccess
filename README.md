...
# Bekanntmachung (final)

**Bekanntmachung**
Gepostet auf **sH1FTSyNc** · **13. September 2025**

**\[Philosophie & Lizenz]**
[statesflowwishes-sketch/dep-checker](https://github.com/statesflowwishes-sketch/dep-checker) • [sh1ftsync (Enterprise)](https://github.com/enterprises/sh1ftsync) • [mozilla/inclusion](https://github.com/mozilla/inclusion) • [statesflowwishes-sketch/securitylab](https://github.com/statesflowwishes-sketch/securitylab)

Dieses Projekt ist **kein klassisches FOSS**. Wir richten uns an **EU-Ethik**, **UN-Menschenrechte** und – soweit anwendbar – Rahmenwerke wie **AI Pact / AI Act** aus. Wir folgen den **HNOSS-Prinzipien**: Transparenz, Beitragsethik, Rechenschaft.
Teile können **source-available** (HNOSS-Lizenz) oder **dual** freigegeben sein. Open-Source-Abhängigkeiten bleiben unter ihren jeweiligen **OSI-Lizenzen**.

**Kultur & Compliance:** Contributor Covenant v2.1 • Provenance & **SBOM (SPDX)** • **signierte Releases** • reproduzierbare Builds.
**Security-Offenlegung:** Bitte folgen Sie den Anweisungen in unserer [Security Policy](.github/SECURITY.md) für vertrauliche Meldungen; Bestätigung binnen **72 h**, koordinierte Offenlegung.
**Transparenz:** Veröffentlichung **eigenverantwortlich**; kein amtlicher Vertretungsanspruch. Bezüge zu AI Pact / AI Act verstehen wir als **Ausrichtung an Prinzipien**, nicht als Amtsstatement.

**Merksatz:** *Offen im Prozess, verantwortlich im Produkt. Consent vor Content; Herkunft vor Hype.*
...
"GitHub ist eine Marke der GitHub, Inc. Dieses Projekt steht in keiner offiziellen Verbindung zu GitHub. 'Learn more at GitHub Security Lab' ist ein Hinweis, kein Sponsoring."
